...
class OpticalFlow PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 integration_time_us() const;
  void set_integration_time_us(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_integration_time_us() const;
  void _internal_set_integration_time_us(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 integration_time_us_;
  float integrated_x_;
  float integrated_y_;
  float quality_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 OpticalFlow::_internal_integration_time_us() const {
  return integration_time_us_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 OpticalFlow::integration_time_us() const {
  // @@protoc_insertion_point(field_get:px4.msgs.OpticalFlow.integration_time_us)
  return _internal_integration_time_us();
}
inline void OpticalFlow::_internal_set_integration_time_us(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  integration_time_us_ = value;
}
inline void OpticalFlow::set_integration_time_us(::PROTOBUF_NAMESPACE_ID::uint32 value) {
